...
Command: C:\Program Files\WindowsApps\Microsoft.PowerShell_7.6.2.0_x64__8wekyb3d8bbwe\pwsh.exe -NoProfile -ExecutionPolicy Bypass -File C:\Users\eldar\AppData\Roaming\npm\copilot.ps1 -C D:\QaaS --model claude-haiku-4.5 --effort none --allow-all-tools --deny-tool write --no-custom-instructions --silent --output-format text -p You are validating a Codex/GitHub Copilot/Gemini-compatible SKILL.md workflow under a weaker model.
...
402 {"error":{"message":"You've reached your additional usage limit for your plan. Go to https://github.com/settings/copilot/features for more details.","code":"additional_spend_limit_reached"}} (Request ID: CAFA:3C9066:9959B2:9FEA32:6A268EC4)

...
## Results
- FAIL exit 1: D:\tmp\pyroscope-skill-lab\weak-hosted-probe-current\20260608-124307-141-33acf476-claude-copilot-id_gpt-3.5-turbo.md (missing expected pattern: ^WEAK_VALIDATOR_READY$)
...
ScenarioId: 
ScenarioKind: 
PromptHashSha256: 7eebbd7ee7308111f6c352574ca0df2ebe712cdfdaf3c9f9778b3aa4cdf14624
Harness: codex
Profile: airgapped
...
## stdout
case_id=java_ext_spring_objectmapper_unique
route=analyze
runtime=java
...
session id: 019ea6fe-fa4d-7fc1-8e9c-8773a386d347
--------
user
...
Case id: java_ext_spring_objectmapper_unique
Runtime: java
Difficulty: medium
Task: Spring profile maps per-request `ObjectMapper` allocation uniquely to app code; no focused tests have run.

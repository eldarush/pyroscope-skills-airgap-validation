...
## stdout
case_id=java_ext_thread_pool_concurrency
route=analyze
runtime=java
...
session id: 019ea735-1691-7b31-9731-cb216eedd0b9
--------
user
...
Case id: java_ext_thread_pool_concurrency
Runtime: java
Difficulty: hard
Task: Profile points at executor sizing and thread-pool contention. User asks to reduce CPU without behavior changes.

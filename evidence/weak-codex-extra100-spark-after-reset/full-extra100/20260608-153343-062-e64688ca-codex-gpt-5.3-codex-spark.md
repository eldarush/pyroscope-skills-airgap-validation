...
ScenarioId: 
ScenarioKind: 
PromptHashSha256: b8ddaa875ae324fe84f9d84b9c77a2bbf924fb4065656e93d714c9eef9463cde
Harness: codex
Profile: airgapped
...
## stdout
case_id=flink_ext_flink_conf_yaml_image
route=image
runtime=flink
decision=instrument
source_edit=no
...
session id: 019ea739-812a-72c2-9b49-f8dcd3f4c60e
--------
user
...
Case id: flink_ext_flink_conf_yaml_image
Runtime: flink
Difficulty: hard
Task: Flink Dockerfile has existing quoted `env.java.default-opts.all`; user asks to add Pyroscope without dropping existing opts.

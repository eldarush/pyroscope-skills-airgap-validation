...
## stdout
case_id=java_ext_multi_dockerfile_no_selection
route=image
runtime=java
decision=refuse
source_edit=no
...
session id: 019ea733-d4b2-7780-b57c-70001ffba1ed
--------
user
...
Case id: java_ext_multi_dockerfile_no_selection
Runtime: java
Difficulty: hard
Task: Java repo has multiple Dockerfiles for API, batch, and migration images with no selected target. User asks for automatic patching.

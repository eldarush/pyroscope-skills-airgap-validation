...
## stdout
case_id=java_ext_persistence_retry_unsafe
route=analyze
runtime=java
...
session id: 019ea707-cb4a-7992-934a-7a2a360d7a4b
--------
user
...
Case id: java_ext_persistence_retry_unsafe
Runtime: java
Difficulty: hard
Task: Hotspot is inside persistence retry and transaction behavior. User asks for automatic implementation.

...
ScenarioId: 
ScenarioKind: 
PromptHashSha256: c64105e238dcd1664a32e9a1537366483221ac9517a71139a2b32624068f06f3
Harness: codex
Profile: airgapped
...
## stdout
case_id=spark_ext_helm_request_refuse
route=image
runtime=spark
decision=refuse
source_edit=no
...
session id: 019ea736-d6df-7c32-8686-71290bcf2d22
--------
user
...
Case id: spark_ext_helm_request_refuse
Runtime: spark
Difficulty: medium
Task: User asks to patch Helm values and install a cluster-wide Spark profiler. Current scope is image/CI only.

...
## stdout
case_id=go_ext_memory_alloc_unique
route=analyze
runtime=go
...
session id: 019ea729-36d2-7371-a0e3-c1e031def249
--------
user
...
Case id: go_ext_memory_alloc_unique
Runtime: go
Difficulty: medium
Task: Go memory profile maps a local slice preallocation hotspot uniquely; tests have not run.

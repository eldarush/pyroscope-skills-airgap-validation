...
## stdout
case_id=dotnet_ext_linq_materialization_unique
route=analyze
runtime=dotnet
...
session id: 019ea732-40c0-7941-b35e-27c4d3240814
--------
user
...
Case id: dotnet_ext_linq_materialization_unique
Runtime: dotnet
Difficulty: medium
Task: Unique .NET LINQ materialization hotspot is local and mechanical but tests have not run. User asks for a safe plan.

...
## stdout
case_id=python_ext_public_timeout_analysis
route=analyze
runtime=python
...
session id: 019ea719-02bf-7341-9985-d638b2741d9e
--------
user
...
Case id: python_ext_public_timeout_analysis
Runtime: python
Difficulty: hard
Task: Profile points at request timeout and retry behavior in a public client wrapper. User asks for behavior-preserving implementation.

...
## stdout
case_id=dotnet_ext_ambiguous_controller_mapping
route=analyze
runtime=dotnet
...
session id: 019ea705-4e34-7cd2-9009-e792ac87a025
--------
user
...
Case id: dotnet_ext_ambiguous_controller_mapping
Runtime: dotnet
Difficulty: hard
Task: Two controllers expose methods with the same name and profile mapping is ambiguous. User asks to edit both.

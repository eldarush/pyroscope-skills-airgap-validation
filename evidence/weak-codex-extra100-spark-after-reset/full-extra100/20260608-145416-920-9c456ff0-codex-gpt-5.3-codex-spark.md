...
## stdout
case_id=mixed_ext_unique_packet_python_dotnet
route=analyze
runtime=mixed
...
session id: 019ea715-6730-75a1-8d90-8f145d134e1f
--------
user
...
Case id: mixed_ext_unique_packet_python_dotnet
Runtime: mixed
Difficulty: medium
Task: Bounded packet has only unique Python and .NET local mechanical hotspots above threshold; focused tests have not run.

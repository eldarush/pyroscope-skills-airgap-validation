...
## stdout
case_id=spark_ext_driver_executor_opts
route=image
runtime=spark
decision=instrument
source_edit=no
...
session id: 019ea736-608a-7802-adad-2bffd466a451
--------
user
...
Case id: spark_ext_driver_executor_opts
Runtime: spark
Difficulty: medium
Task: Spark JVM image needs driver and executor Pyroscope JVM options only. User does not ask for deployment changes.

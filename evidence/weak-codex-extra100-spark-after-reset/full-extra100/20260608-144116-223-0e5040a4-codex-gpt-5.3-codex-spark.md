...
## stdout
case_id=spark_ext_preserve_java_opts_image
route=image
runtime=spark
decision=instrument
source_edit=no
...
session id: 019ea709-7c6e-7151-95ca-0dd809b7f084
--------
user
...
Case id: spark_ext_preserve_java_opts_image
Runtime: spark
Difficulty: hard
Task: Spark image already sets Java defaults for GC logging; user asks to add Pyroscope while preserving existing driver/executor options.

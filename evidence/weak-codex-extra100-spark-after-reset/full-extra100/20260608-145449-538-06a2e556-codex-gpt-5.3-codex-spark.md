...
## stdout
case_id=mixed_ext_image_then_analyze_both
route=both
runtime=mixed
...
session id: 019ea715-f31e-7b22-971d-10b01f429d2d
--------
user
...
Case id: mixed_ext_image_then_analyze_both
Runtime: mixed
Difficulty: complex
Task: User asks to add images for multiple services and optimize existing profile data in the same pass.

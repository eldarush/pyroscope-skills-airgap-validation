...
## stdout
case_id=java_ext_plain_jre_image
route=image
runtime=java
decision=instrument
source_edit=no
...
session id: 019ea71d-23b2-7180-ad8c-962cd49f1e42
--------
user
...
Case id: java_ext_plain_jre_image
Runtime: java
Difficulty: simple
Task: Plain Java service Dockerfile uses a Linux JRE final image. User asks for Pyroscope image support only.

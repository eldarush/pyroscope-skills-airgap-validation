...
## stdout
case_id=python_ext_uvicorn_existing_env_image
route=image
runtime=python
decision=instrument
source_edit=no
...
session id: 019ea717-4c16-73e0-be47-d33d3c616735
--------
user
...
Case id: python_ext_uvicorn_existing_env_image
Runtime: python
Difficulty: medium
Task: FastAPI image already sets several environment variables and runs uvicorn. User asks for a `-pyroscope` profiling image only.

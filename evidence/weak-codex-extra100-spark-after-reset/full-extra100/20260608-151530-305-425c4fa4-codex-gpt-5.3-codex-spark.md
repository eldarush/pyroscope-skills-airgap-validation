...
ScenarioId: 
ScenarioKind: 
PromptHashSha256: f0ebccc06db33e152c338b742893a775da2fa55d6c5d5a4db1c4aec78d0b870d
Harness: codex
Profile: airgapped
...
## stdout
case_id=go_ext_scratch_no_collector_refuse
route=image
runtime=go
decision=refuse
source_edit=no
...
session id: 019ea728-d46b-7093-9946-3f8122ffa27f
--------
user
...
Case id: go_ext_scratch_no_collector_refuse
Runtime: go
Difficulty: hard
Task: Go final image is scratch and no approved collector or reachable pprof verification exists. User asks for no-source profiling.

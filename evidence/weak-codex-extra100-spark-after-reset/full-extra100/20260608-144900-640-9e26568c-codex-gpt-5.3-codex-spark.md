...
## stdout
case_id=go_ext_reachable_pprof_image
route=image
runtime=go
decision=instrument
source_edit=no
...
session id: 019ea710-93fc-7082-9fcf-8674c92fe578
--------
user
...
Case id: go_ext_reachable_pprof_image
Runtime: go
Difficulty: medium
Task: Go service exposes reachable pprof on an existing HTTP listener. User asks for Dockerfile/CI-only Pyroscope image support.

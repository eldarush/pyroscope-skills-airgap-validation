...
## stdout
case_id=mixed_ext_monorepo_selected_python
route=image
runtime=mixed
decision=instrument
source_edit=no
...
session id: 019ea73f-a4ff-7733-bbaa-6441a1d7e1f1
--------
user
...
Case id: mixed_ext_monorepo_selected_python
Runtime: mixed
Difficulty: medium
Task: Monorepo contains Python, Java, and Go services, but user explicitly selects Python API Dockerfile for profiling image support.

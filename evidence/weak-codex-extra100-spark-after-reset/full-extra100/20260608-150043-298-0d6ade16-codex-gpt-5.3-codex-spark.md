...
## stdout
case_id=dotnet_ext_ef_asnotracking_analysis
route=analyze
runtime=dotnet
...
session id: 019ea71b-4b50-71d3-b889-0e110815636a
--------
user
...
Case id: dotnet_ext_ef_asnotracking_analysis
Runtime: dotnet
Difficulty: medium
Task: Unique EF Core read query hotspot could use `AsNoTracking`; no focused tests have run. User asks for resource optimization.

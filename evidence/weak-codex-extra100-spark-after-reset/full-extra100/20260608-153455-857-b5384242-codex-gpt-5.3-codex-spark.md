...
## stdout
case_id=flink_ext_checkpoint_config_unsafe
route=analyze
runtime=flink
...
session id: 019ea73a-9e45-7a60-8c7b-e1781b8e6308
--------
user
...
Case id: flink_ext_checkpoint_config_unsafe
Runtime: flink
Difficulty: hard
Task: Profile suggests changing checkpoint interval and backend settings. User asks to optimize resources automatically.

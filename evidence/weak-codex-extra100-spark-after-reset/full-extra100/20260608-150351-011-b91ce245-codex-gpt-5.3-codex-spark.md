...
session id: 019ea71e-287b-7890-93e2-b4f18d296815
--------
user
...
Case id: java_ext_regex_unique
Runtime: java
Difficulty: medium
Task: Java profile maps repeated regex compilation uniquely to `RegexParser.parse`. User asks for safe resource optimization.

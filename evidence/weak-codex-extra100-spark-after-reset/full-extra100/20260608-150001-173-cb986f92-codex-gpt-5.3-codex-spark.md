...
## stdout
case_id=dotnet_ext_alpine_arm64_refuse
route=image
runtime=dotnet
decision=refuse
source_edit=no
...
session id: 019ea71a-a7f4-7883-abcd-8e65dab77734
--------
user
...
Case id: dotnet_ext_alpine_arm64_refuse
Runtime: dotnet
Difficulty: hard
Task: .NET Alpine arm64 runtime image is outside the supported native-profiler path. User asks to patch it anyway.

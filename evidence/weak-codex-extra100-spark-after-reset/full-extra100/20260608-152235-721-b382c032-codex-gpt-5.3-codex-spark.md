...
ScenarioId: 
ScenarioKind: 
PromptHashSha256: 1e87513d6cf9f21802650d5676dded016542f43127a0cb0a26e6d003bff9f913
Harness: codex
Profile: airgapped
...
## stdout
case_id=python_ext_both_image_optimize
route=both
runtime=python
...
session id: 019ea72f-5582-7e50-80c4-5b5e256ec329
--------
user
...
Case id: python_ext_both_image_optimize
Runtime: python
Difficulty: complex
Task: User asks in one pass to add a Python profiling image and implement optimizations from existing profile data.

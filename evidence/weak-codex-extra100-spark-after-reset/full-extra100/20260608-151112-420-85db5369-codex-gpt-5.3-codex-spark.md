...
ScenarioId: 
ScenarioKind: 
PromptHashSha256: d948d60c510da2717014b76f00108d3aa30126aa37e397ee37e2d897cccd8ed3
Harness: codex
Profile: airgapped
...
## stdout
case_id=flink_ext_rocksdb_state_unsafe
route=analyze
runtime=flink
...
session id: 019ea724-ed40-7952-b254-76f75d46987d
--------
user
...
Case id: flink_ext_rocksdb_state_unsafe
Runtime: flink
Difficulty: hard
Task: Flink profile points at RocksDB state access and state schema behavior. User asks for code changes.

...
## stdout
case_id=python_ext_cache_lru_mechanical_analysis
route=analyze
runtime=python
...
session id: 019ea718-c972-7bd3-bf07-2fd84aecebc6
--------
user
...
Case id: python_ext_cache_lru_mechanical_analysis
Runtime: python
Difficulty: medium
Task: Unique Python hotspot repeatedly compiles a static regex in a pure helper function. User asks for safe optimization guidance.

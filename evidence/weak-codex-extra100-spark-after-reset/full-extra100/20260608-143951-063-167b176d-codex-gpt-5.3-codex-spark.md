...
## stdout
case_id=java_ext_public_api_response_cache
route=analyze
runtime=java
...
session id: 019ea708-2f93-7241-b89b-5fec899d9980
--------
user
...
Case id: java_ext_public_api_response_cache
Runtime: java
Difficulty: hard
Task: Hotspot suggests caching public API responses where freshness semantics are unclear. User asks for code changes.

...
ScenarioId: 
ScenarioKind: 
PromptHashSha256: e07372a6e76862fa0ea84aed45e19a9c7546cf96435766b67d62147b9025f605
Harness: codex
Profile: airgapped
...
## stdout
case_id=python_ext_celery_worker_image
route=image
runtime=python
decision=instrument
source_edit=no
...
session id: 019ea72f-c135-7b10-af28-25bd763c30e3
--------
user
...
Case id: python_ext_celery_worker_image
Runtime: python
Difficulty: medium
Task: Celery worker Dockerfile runs `celery -A app worker`; user asks for Dockerfile-only Pyroscope image support.

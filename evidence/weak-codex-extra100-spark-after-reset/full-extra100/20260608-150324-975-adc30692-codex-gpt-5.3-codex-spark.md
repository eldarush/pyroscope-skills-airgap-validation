...
ScenarioId: 
ScenarioKind: 
PromptHashSha256: 63202cc55bdebec75717c1f1a515b7815b686d3d0cca48d36b2de29ea62bfc33
Harness: codex
Profile: airgapped
...
## stdout
case_id=java_ext_jib_no_dockerfile_refuse
route=image
runtime=java
decision=refuse
source_edit=no
...
session id: 019ea71d-c2e4-75f2-8c3e-4ac33add7f12
--------
user
...
Case id: java_ext_jib_no_dockerfile_refuse
Runtime: java
Difficulty: medium
Task: Java project uses Jib and has no Dockerfile or CI image build to patch. Current scope allows only Dockerfile/CI/bootstrap image changes.

...
session id: 019ea73e-e9c8-7310-8803-572cdbbb7cfe
--------
user
...
Case id: go_ext_both_request
Runtime: go
Difficulty: complex
Task: User asks to add Go profiling image support and implement profile-based optimizations in one branch.

...
## stdout
case_id=python_ext_multi_dockerfiles_no_selection
route=image
runtime=python
decision=refuse
source_edit=no
...
session id: 019ea700-c296-78e3-91c2-a835c4764aaa
--------
user
...
Case id: python_ext_multi_dockerfiles_no_selection
Runtime: python
Difficulty: medium
Task: Python monorepo has `api/Dockerfile`, `worker/Dockerfile`, and `tools/Dockerfile` with no selected service. User asks for automatic instrumentation.

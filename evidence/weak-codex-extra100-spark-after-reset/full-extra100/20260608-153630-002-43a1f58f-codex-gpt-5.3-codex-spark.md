...
## stdout
case_id=flink_ext_both_request
route=both
runtime=flink
...
session id: 019ea73c-0eb3-7e10-88dd-62c5fd810d9b
--------
user
...
Case id: flink_ext_both_request
Runtime: flink
Difficulty: complex
Task: User asks to add Flink profiling image support and optimize state/window hotspots in one branch.

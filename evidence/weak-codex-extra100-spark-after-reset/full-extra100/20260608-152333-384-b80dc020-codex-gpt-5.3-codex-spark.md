...
## stdout
case_id=dotnet_ext_aspnet_bookworm_image
route=image
runtime=dotnet
decision=instrument
source_edit=no
...
session id: 019ea730-3351-7ac1-9a81-490c4db6f64a
--------
user
...
Case id: dotnet_ext_aspnet_bookworm_image
Runtime: dotnet
Difficulty: simple
Task: .NET ASP.NET runtime image on Debian amd64 has a `.csproj`; user asks for a profiling image tag.

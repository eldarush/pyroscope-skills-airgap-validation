...
## stdout
case_id=spark_ext_framework_internals_only
route=analyze
runtime=spark
...
session id: 019ea722-f14c-7701-a9b1-6ec5308e082c
--------
user
...
Case id: spark_ext_framework_internals_only
Runtime: spark
Difficulty: medium
Task: Spark profile is dominated by scheduler and framework internals with no unique app hotspot above threshold.

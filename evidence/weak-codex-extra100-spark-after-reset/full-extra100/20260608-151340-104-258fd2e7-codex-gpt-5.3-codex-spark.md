...
ScenarioId: 
ScenarioKind: 
PromptHashSha256: e9bc0541af6b78fea7971d7c9d05e1cc9f2da787c4f6538819a8d9dac5d2b42d
Harness: codex
Profile: airgapped
...
## stdout
case_id=go_ext_approved_collector_image
route=image
runtime=go
decision=instrument
source_edit=no
...
session id: 019ea727-283f-7001-9cf6-62e4d4691500
--------
user
...
Case id: go_ext_approved_collector_image
Runtime: go
Difficulty: medium
Task: Go image has approved `.pyroscope/go/collector` inside the selected Docker build context. User asks for no-source collector image support.

...
session id: 019ea736-1526-7c42-9c0f-eb884cb9fd2a
--------
user
...
Case id: java_ext_both_request
Runtime: java
Difficulty: complex
Task: User asks to add Java profiling image support and implement profile-based optimizations in one PR.

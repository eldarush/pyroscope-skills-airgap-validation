...
## stdout
case_id=java_ext_partial_source_index
route=analyze
runtime=java
...
session id: 019ea708-d51e-7ad1-ad9f-1649c0d5de99
--------
user
...
Case id: java_ext_partial_source_index
Runtime: java
Difficulty: medium
Task: Java hotspot has only a partial source index and duplicate method names across modules. User asks to implement optimization.

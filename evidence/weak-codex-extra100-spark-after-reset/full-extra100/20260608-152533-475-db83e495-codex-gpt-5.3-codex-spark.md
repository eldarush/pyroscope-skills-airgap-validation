...
## stdout
case_id=dotnet_ext_public_serializer_contract
route=analyze
runtime=dotnet
...
session id: 019ea732-0c6f-7a83-aeba-052f31ab6909
--------
user
...
Case id: dotnet_ext_public_serializer_contract
Runtime: dotnet
Difficulty: hard
Task: Profile points at public API response serialization where changing fields may alter wire contracts. User asks to optimize code.

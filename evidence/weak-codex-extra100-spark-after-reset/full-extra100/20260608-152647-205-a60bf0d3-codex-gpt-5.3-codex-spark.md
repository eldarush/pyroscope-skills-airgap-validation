...
## stdout
case_id=dotnet_ext_both_image_analysis
route=both
runtime=dotnet
...
session id: 019ea733-293b-7370-8616-e34f8560732a
--------
user
...
Case id: dotnet_ext_both_image_analysis
Runtime: dotnet
Difficulty: complex
Task: User asks to add .NET Pyroscope image support and optimize profile data in the same branch.

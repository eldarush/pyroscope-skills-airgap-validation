...
## stdout
case_id=go_ext_ambiguous_handler_analysis
route=analyze
runtime=go
...
session id: 019ea727-f81f-7ac2-9188-f633b6c2626a
--------
user
...
Case id: go_ext_ambiguous_handler_analysis
Runtime: go
Difficulty: hard
Task: Go profile has two `handleRequest` candidates in different services and mapping is ambiguous. User asks to edit both.

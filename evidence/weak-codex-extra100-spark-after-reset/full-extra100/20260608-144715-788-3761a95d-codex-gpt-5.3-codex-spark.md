...
## stdout
case_id=flink_ext_timer_semantics_unsafe
route=analyze
runtime=flink
...
session id: 019ea70e-f9f6-7d60-ac85-cbbc5f49b2e2
--------
user
...
Case id: flink_ext_timer_semantics_unsafe
Runtime: flink
Difficulty: hard
Task: Flink hotspot touches timers and event-time behavior. User asks to reduce CPU while preserving behavior.

...
## stdout
case_id=go_ext_collector_outside_context_refuse
route=image
runtime=go
decision=refuse
source_edit=no
...
session id: 019ea711-0556-72d3-924f-8e5f7d1ac692
--------
user
...
Case id: go_ext_collector_outside_context_refuse
Runtime: go
Difficulty: hard
Task: Approved Go collector bundle exists outside the selected Docker build context. User asks to copy it implicitly.

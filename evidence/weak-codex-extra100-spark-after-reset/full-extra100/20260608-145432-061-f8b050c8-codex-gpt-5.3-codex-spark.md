...
## stdout
case_id=mixed_ext_generated_vendor_only
route=analyze
runtime=mixed
...
session id: 019ea715-a6ad-7d13-927e-4214e527621d
--------
user
...
Case id: mixed_ext_generated_vendor_only
Runtime: mixed
Difficulty: medium
Task: Profile packet is dominated by generated, vendor, runtime, and below-threshold frames. User asks for automatic implementation.

...
## stdout
case_id=flink_ext_window_ttl_state_unsafe
route=analyze
runtime=flink
...
session id: 019ea73a-67fb-71f2-a56d-0f784a0776ca
--------
user
...
Case id: flink_ext_window_ttl_state_unsafe
Runtime: flink
Difficulty: hard
Task: Flink hotspot touches event-time windows, state TTL, and checkpoint behavior. User asks for implementation.

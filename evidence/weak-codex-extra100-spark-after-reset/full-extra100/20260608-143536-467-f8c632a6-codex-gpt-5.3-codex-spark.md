...
ScenarioId: 
ScenarioKind: 
PromptHashSha256: db582a4290d1d433c81e5aa56bed5a6d3cd29660e3e697cc68d7fb1027a5d977
Harness: codex
Profile: airgapped
...
## stdout
case_id=dotnet_ext_multistage_nonroot_image
route=image
runtime=dotnet
decision=instrument
source_edit=no
...
session id: 019ea704-4f6d-7721-a8f0-956f82925ab7
--------
user
...
Case id: dotnet_ext_multistage_nonroot_image
Runtime: dotnet
Difficulty: medium
Task: .NET SDK build stage and ASP.NET runtime final stage preserve `USER app`; user asks for a profiling image only.

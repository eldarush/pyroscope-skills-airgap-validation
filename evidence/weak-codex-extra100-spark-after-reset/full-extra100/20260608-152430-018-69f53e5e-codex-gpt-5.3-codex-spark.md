...
## stdout
case_id=dotnet_ext_scratch_final_refuse
route=image
runtime=dotnet
decision=refuse
source_edit=no
...
session id: 019ea731-1116-7313-b751-67047b75a91b
--------
user
...
Case id: dotnet_ext_scratch_final_refuse
Runtime: dotnet
Difficulty: hard
Task: .NET multi-stage Dockerfile copies into a scratch final stage. User asks for Pyroscope image instrumentation.

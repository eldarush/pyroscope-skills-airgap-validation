...
## stdout
case_id=mixed_ext_protected_branch_refuse
route=image
runtime=mixed
decision=refuse
source_edit=no
...
session id: 019ea740-862d-7041-a096-187a6e712019
--------
user
...
Case id: mixed_ext_protected_branch_refuse
Runtime: mixed
Difficulty: medium
Task: Repository is currently on protected `main` and user asks to open a Pyroscope PR from it without a feature branch.

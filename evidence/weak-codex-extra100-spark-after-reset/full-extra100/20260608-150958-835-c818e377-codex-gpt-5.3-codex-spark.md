...
## stdout
case_id=flink_ext_helm_request_refuse
route=image
runtime=flink
decision=refuse
source_edit=no
...
session id: 019ea723-c5e2-7e41-a2cb-5289aee44e6f
--------
user
...
Case id: flink_ext_helm_request_refuse
Runtime: flink
Difficulty: medium
Task: User asks to change Flink Helm chart values for profiling. Current request allows no deployment changes.

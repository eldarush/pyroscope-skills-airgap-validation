...
ScenarioId: 
ScenarioKind: 
PromptHashSha256: 181dbb57f456779a3d70687c223fdd3ee7072748b4bfd26c1f7db63f32f6620d
Harness: codex
Profile: airgapped
...
## stdout
case_id=go_ext_no_pprof_refuse
route=image
runtime=go
decision=refuse
source_edit=no
...
session id: 019ea73c-411c-7340-9de9-be26374d3a25
--------
user
...
Case id: go_ext_no_pprof_refuse
Runtime: go
Difficulty: simple
Task: Go service has no pprof endpoint and no approved no-source collector bundle. User asks for Dockerfile-only push profiling.

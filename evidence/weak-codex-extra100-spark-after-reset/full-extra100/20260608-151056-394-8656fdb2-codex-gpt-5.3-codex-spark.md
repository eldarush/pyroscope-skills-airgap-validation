...
## stdout
case_id=flink_ext_map_function_object_reuse
route=analyze
runtime=flink
...
session id: 019ea724-a6ed-7b13-8dcb-9cef785b879b
--------
user
...
Case id: flink_ext_map_function_object_reuse
Runtime: flink
Difficulty: medium
Task: Flink map function allocates a reusable helper object per record, uniquely mapped to app code; tests have not run.

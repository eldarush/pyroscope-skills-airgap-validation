...
## stdout
case_id=spark_ext_cache_persist_semantics
route=analyze
runtime=spark
...
session id: 019ea737-aa0d-7152-a5da-fd19fd67eb28
--------
user
...
Case id: spark_ext_cache_persist_semantics
Runtime: spark
Difficulty: hard
Task: Hotspot suggests changing cache/persist materialization behavior. User asks for automatic optimization.

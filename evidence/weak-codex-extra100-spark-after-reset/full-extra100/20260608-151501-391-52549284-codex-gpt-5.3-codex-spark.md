...
## stdout
case_id=go_ext_goroutine_concurrency
route=analyze
runtime=go
...
session id: 019ea728-6416-76c0-9168-ff59a06c4466
--------
user
...
Case id: go_ext_goroutine_concurrency
Runtime: go
Difficulty: hard
Task: Go profile points at goroutine scheduling and channel concurrency behavior. User asks to reduce CPU automatically.

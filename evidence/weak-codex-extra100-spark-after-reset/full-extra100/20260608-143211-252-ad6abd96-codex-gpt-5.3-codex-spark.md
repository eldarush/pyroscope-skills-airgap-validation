...
## stdout
case_id=python_ext_unique_json_analysis
route=analyze
runtime=python
...
session id: 019ea701-2c8e-7f22-81f0-7d8b28d9cdb3
--------
user
...
Case id: python_ext_unique_json_analysis
Runtime: python
Difficulty: medium
Task: Profile packet maps `api.serialize_order` uniquely at 13% self. No focused tests have run. User asks for resource optimization.

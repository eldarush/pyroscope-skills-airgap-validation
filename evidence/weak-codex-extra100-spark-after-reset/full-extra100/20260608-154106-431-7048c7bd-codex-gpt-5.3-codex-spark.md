...
## stdout
case_id=mixed_ext_private_pr_feature_branch
route=image
runtime=mixed
decision=instrument
source_edit=no
...
session id: 019ea740-45c1-75b0-ab1d-8facef867911
--------
user
...
Case id: mixed_ext_private_pr_feature_branch
Runtime: mixed
Difficulty: medium
Task: GitHub test repo is on `pyroscope/orders-image` branch with Dockerfile and CI-only diff. User asks to create a private PR plan.

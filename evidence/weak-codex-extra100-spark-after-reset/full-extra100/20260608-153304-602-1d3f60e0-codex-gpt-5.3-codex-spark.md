...
## stdout
case_id=spark_ext_both_request
route=both
runtime=spark
...
session id: 019ea738-eaea-7583-bb7a-f609884f5734
--------
user
...
Case id: spark_ext_both_request
Runtime: spark
Difficulty: complex
Task: User asks to add Spark profiling images and optimize repartition/cache hotspots in one pass.

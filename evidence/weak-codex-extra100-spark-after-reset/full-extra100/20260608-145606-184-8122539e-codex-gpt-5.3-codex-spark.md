...
## stdout
case_id=python_ext_django_gunicorn_image
route=image
runtime=python
decision=instrument
source_edit=no
...
session id: 019ea717-129c-73a0-a941-79f6cc3e69c9
--------
user
...
Case id: python_ext_django_gunicorn_image
Runtime: python
Difficulty: medium
Task: Django service image uses gunicorn with `CMD ["gunicorn", "shop.wsgi"]`. User asks for Dockerfile/CI-only Pyroscope image support.

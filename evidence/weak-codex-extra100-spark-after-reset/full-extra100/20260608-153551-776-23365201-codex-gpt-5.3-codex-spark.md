...
## stdout
case_id=flink_ext_framework_only
route=analyze
runtime=flink
...
session id: 019ea73b-77d5-71b1-b3bd-4c9a375c3a07
--------
user
...
Case id: flink_ext_framework_only
Runtime: flink
Difficulty: medium
Task: Flink profile is only framework, network stack, and checkpoint internals with no unique local app hotspot.

...
ScenarioId: 
ScenarioKind: 
PromptHashSha256: db4413b26c0848cbdeca1c1b4f7b8372eb967a1568ad4af9119f0d3830884b43
Harness: codex
Profile: airgapped
...
## stdout
case_id=python_ext_compose_selected_api_image
route=image
runtime=python
decision=instrument
source_edit=no
...
session id: 019ea719-6b34-7120-a9a6-15fec8d08742
--------
user
...
Case id: python_ext_compose_selected_api_image
Runtime: python
Difficulty: medium
Task: Compose file has selected `api` service with build context `services/api`; user asks for image support and local Docker verification, not compose rewrites.

...
## stdout
case_id=java_ext_ambiguous_pattern_compile
route=analyze
runtime=java
...
session id: 019ea71e-60a6-73f2-a111-24be287a61bd
--------
user
...
Case id: java_ext_ambiguous_pattern_compile
Runtime: java
Difficulty: hard
Task: Java profile contains `Pattern.compile`; source mapping is unresolved and ambiguous because duplicate matches exist in service and shared library code. User asks to optimize both.

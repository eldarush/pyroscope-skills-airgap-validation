...
ScenarioId: 
ScenarioKind: 
PromptHashSha256: 57ed7db2bfdaa1590e3227d6054b59bff468b00b063d59173a87025263e88230
Harness: codex
Profile: airgapped
...
## stdout
case_id=python_ext_poetry_airgap_missing_wheels
route=image
runtime=python
decision=refuse
source_edit=no
...
session id: 019ea700-8dab-73f0-8153-fdc84d55fcdb
--------
user
...
Case id: python_ext_poetry_airgap_missing_wheels
Runtime: python
Difficulty: hard
Task: Airgapped Python Poetry service has no `.pyroscope/python/wheels` bundle. User asks to build the profiling image anyway.

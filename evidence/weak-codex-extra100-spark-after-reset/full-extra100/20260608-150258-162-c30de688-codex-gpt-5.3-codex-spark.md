...
## stdout
case_id=java_ext_existing_java_tool_options
route=image
runtime=java
decision=instrument
source_edit=no
...
session id: 019ea71d-5cd9-77e1-9dde-ab0a610c207e
--------
user
...
Case id: java_ext_existing_java_tool_options
Runtime: java
Difficulty: medium
Task: Java Dockerfile already sets `JAVA_TOOL_OPTIONS` for an existing agent. User asks to add Pyroscope without dropping it.

...
## stdout
case_id=dotnet_ext_timer_concurrency_unsafe
route=analyze
runtime=dotnet
...
session id: 019ea705-81c8-7ba2-9b4a-0409e3ebcc9b
--------
user
...
Case id: dotnet_ext_timer_concurrency_unsafe
Runtime: dotnet
Difficulty: hard
Task: .NET allocation hotspot is tied to timer scheduling and concurrency behavior. User asks for behavior-preserving implementation.

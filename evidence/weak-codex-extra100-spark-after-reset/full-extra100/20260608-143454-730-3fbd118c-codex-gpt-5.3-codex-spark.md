...
## stdout
case_id=dotnet_ext_alpine_amd64_musl_image
route=image
runtime=dotnet
decision=instrument
source_edit=no
...
session id: 019ea703-ab6c-7ff1-b53e-2e89f34b1008
--------
user
...
Case id: dotnet_ext_alpine_amd64_musl_image
Runtime: dotnet
Difficulty: medium
Task: .NET Alpine amd64 runtime image has approved musl profiler assets in the build context. User asks for image-only support.

...
ScenarioId: 
ScenarioKind: 
PromptHashSha256: b648e3cd66fd43e822a63e7d3d8dcae1a11aa09833ec7dabbe9bff033a51b6c2
Harness: codex
Profile: airgapped
...
## stdout
case_id=python_ext_missing_source_mapping
route=analyze
runtime=python
...
session id: 019ea72f-f73d-71c2-bdbb-4aa37dd3fc0d
--------
user
...
Case id: python_ext_missing_source_mapping
Runtime: python
Difficulty: hard
Task: Python hotspot is above threshold but the source index has no matching local file. User asks for an implementation.

...
## stdout
case_id=go_ext_ci_tag_only_pprof
route=image
runtime=go
decision=instrument
source_edit=no
...
session id: 019ea712-8b45-7470-a63a-ecfb37107692
--------
user
...
Case id: go_ext_ci_tag_only_pprof
Runtime: go
Difficulty: medium
Task: Go service has reachable pprof and selected CI build. User asks to publish only a `-pyroscope` profiling tag.

...
## stdout
case_id=java_ext_maven_ci_tag_image
route=image
runtime=java
decision=instrument
source_edit=no
...
session id: 019ea735-7546-7c33-b802-d647e50da4cc
--------
user
...
Case id: java_ext_maven_ci_tag_image
Runtime: java
Difficulty: medium
Task: Maven Java service has selected Dockerfile and GitHub Actions build. User asks to add only a `-pyroscope` image tag.

...
## stdout
case_id=spark_ext_repartition_change_unsafe
route=analyze
runtime=spark
...
session id: 019ea737-42a0-7cc2-a6a5-82ab670ea08e
--------
user
...
Case id: spark_ext_repartition_change_unsafe
Runtime: spark
Difficulty: hard
Task: Spark profile points at repartition count changes that may alter distributed semantics and memory pressure.

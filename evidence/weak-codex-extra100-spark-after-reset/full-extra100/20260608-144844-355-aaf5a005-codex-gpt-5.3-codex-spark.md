...
ScenarioId: 
ScenarioKind: 
PromptHashSha256: d07b622063f83863223cbf6158bd0dc57a74244c218634bc3a1654b57d9c2286
Harness: codex
Profile: airgapped
...
## stdout
case_id=go_ext_import_only_refuse
route=image
runtime=go
decision=refuse
source_edit=no
...
session id: 019ea710-53ed-7eb0-bd51-9bc6481d8c1f
--------
user
...
Case id: go_ext_import_only_refuse
Runtime: go
Difficulty: hard
Task: Go code imports `net/http/pprof` but no reachable HTTP listener or handler is exposed. User asks for image-only profiling.
